  ...
  return (
    <div className="container text-center ps-sm-7 pe-sm-7 ps-xl-15 pe-xl-15">
      ...
      <div className="border border-secondary-subtle border-1 rounded-2 text-start pt-3 pb-3">
        ...
        <p className ="ms-5 fs-7">Enter the email address associated with your GymBro account. An email will be sent to your email address for resetting the password shortly.</p>
        <form>
