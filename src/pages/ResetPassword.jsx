      ...
      <div className="border border-secondary-subtle border-1 rounded-2 text-start pt-3 pb-3">
        ...
        <form>
          <div className="ps-5 pe-5 mt-2">
            <label htmlFor="new-password" className="form-label fw-medium fs-13">
              New Password
            </label>
            <input type="password" className="form-control fs-13" id="new-password" />
          </div>
          <div className="ps-5 pe-5 mt-2">
            <label htmlFor="reenter-password" className="form-label fw-medium fs-13">
              Re-enter Password
            </label>
            <input type="password" className="form-control fs-13" id="reenter-password" />
          </div>
